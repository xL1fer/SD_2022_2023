...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Museum museum = new Museum(paintingRooms, partyMembersNumber, partiesNumber, maxRoomPaintings);   // museum object
        ...
        System.out.println("Museum Stub was generated!");

        // register it with the general registry service

        String nameEntryBase = "RegisterHandler";               // public name of the object that enables the registration
                                                                // of other remote objects
        String nameEntryObject = "Museum";                      // public name of the museum site object
        ...
        try {
            while (!end) {
                synchronized(Class.forName("Museum.Main")) {
                    try {
                        (Class.forName("Museum.Main")).wait();
            ...
            System.out.println("The data type Museum.Main was not found (blocking)!");
            e.printStackTrace();
            System.exit(1);
        }
    ...
    public static void shutdown() {
        ...
        try {
            synchronized(Class.forName("Museum.Main")) {
                (Class.forName("Museum.Main")).notify();
            }
        } catch (ClassNotFoundException e) {
            System.out.println("The data type Museum.Main was not found (waking up)!");
            e.printStackTrace();
            System.exit(1);
        }
    }
