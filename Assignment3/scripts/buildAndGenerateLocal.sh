...
zip -rq dirRegistry.zip dirRegistry dirRMIRegistry/set_rmiregistry_alt.sh
echo "  Information Repository"
...
cp dirRegistry.zip $HOME/test/MuseumHeist
...
mv dirRMIRegistry/set_rmiregistry_alt.sh $HOME/test
