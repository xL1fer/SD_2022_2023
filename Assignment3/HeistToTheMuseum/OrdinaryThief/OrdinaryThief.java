...
public class OrdinaryThief extends Thief {
     ...
     */
    public OrdinaryThief(int currentState, InformationRepositoryInterface infReposStub, ConcentrationSiteInterface conSiteStub,
            CollectionSiteInterface colSiteStub, AssaultPartyInterface assaultPartyStub, MuseumInterface museumStub, int thiefId, int maximumDisplacement, int partyId, int[][] museumRooms) {
        super(currentState);
    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                System.out.println("Ordinary Thief remote exception on amINeeded: " + e.getMessage());
                System.exit(1);
            }
            ...
            try {
                ...
                System.out.println("Ordinary Thief remote exception on prepareExcursion: " + e.getMessage());
                System.exit(1);
            }
            ...
            try {
                ...
                System.out.println("Ordinary Thief remote exception on crawlIn/writeStatesLog: " + e.getMessage());
                System.exit(1);
            }
            ...
            try {
                ...
                System.out.println("Ordinary Thief remote exception on rollACanvas: " + e.getMessage());
                System.exit(1);
            }
            ...
            try {
                ...
                System.out.println("Ordinary Thief remote exception on reverseDirection: " + e.getMessage());
                System.exit(1);
            }
            ...
            try {
                ...
                System.out.println("Ordinary Thief remote exception on crawlOut/writeStatesLog: " + e.getMessage());
                System.exit(1);
            }
            ...
            try {
                this.colSiteStub.handACanvas(this.thiefId, this.partyId, this.hasCanvas, this.partyTargetRoomId);
            } catch (RemoteException e) {
                System.out.println("Ordinary Thief remote exception on handACanvas: " + e.getMessage());
                System.exit(1);
            }
            this.hasCanvas = false;
        ...
        try {
            ...
            System.out.println("Ordinary Thief remote exception on thiefLeaving: " + e.getMessage());
            System.exit(1);
        }
    ...
    public void changeState(int state, boolean isPartyActive, int removeCanvas) {
        ...
        try {
            ...
            System.out.println("Ordinary Thief remote exception on writeStatesLog: " + e.getMessage());
            System.exit(1);
        }
    }
     ...
     */
    public AssaultPartyInterface getAssaultPartyStub() {
     ...
     * @param assaultPartyStub assault party stub
     */
    public void setAssaultPartyStub(AssaultPartyInterface assaultPartyStub) {
        this.assaultPartyStub = assaultPartyStub;
    }
     ...
     * @return museum stub
     */
    public MuseumInterface getMuseumStub() {
        return museumStub;
    }
     ...
     * @param museumStub museum stub
     */
    public void setMuseumStub(MuseumInterface museumStub) {
        this.museumStub = museumStub;
    }
}