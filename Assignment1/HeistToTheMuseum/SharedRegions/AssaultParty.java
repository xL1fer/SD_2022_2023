...
public class AssaultParty {
     ...
     * @param roomDistances museum rooms distances
     * @param partyId party identification
     */
    public AssaultParty(int maxRoomDistance, int partyMembersNumber, int partySeparationLimit, int partyId, int[] roomDistances) {
