...
public class InformationRepository {
     ...
     */
    public InformationRepository(int assaultPartiesNumber, int partyMembersNumber) {
        try {
    ...
    /**
     * Set museum rooms info.
     * 
     * @param museumRooms museum rooms info
     */
    ...
    /**
     * Fill ordinary thieves maximum displacements.
     * 
     * @param maximumDisplacements thieves maximum displacements
     */
    public void fillMaximumDisplacement(int[] maximumDisplacements) {
        this.ordinaryThievesStates[3] = maximumDisplacements;
    }
}